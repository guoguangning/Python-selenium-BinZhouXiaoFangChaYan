...
class YdmVerify(object):
    ...
    _token = "s3Bq6034gMQALrqrRvKrLuaEM3RN-jrVyua2V_F2sn0"
    _headers = {
...
if __name__ == '__main__':
    y = YdmVerify()
    img_path = 'C:\case\BinZhouXiaoFangChaYan\screenshots\Captcha\微信截图_20240816173557.png'
    image_data = open(img_path, 'rb').read()
    y.common_verify(image='image_data', verify_type='50100')
